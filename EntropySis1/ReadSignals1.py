...
# Performs the read, filtering and plot the seismic signals
...
# Program: ReadSignals1.py -> Performs the read, filtering and plot the seismic signals
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_10.setPixmap(QtGui.QPixmap("Images/IAG.gif"))  # IAG logo
        ...
        self.label_11.setPixmap(QtGui.QPixmap("Images/Ugr.gif"))  # Ugr Logo
        ...
        self.label_29.setPixmap(QtGui.QPixmap("Images/LogoTSTC.gif"))  # TSTC logo
    ...
    def Read_records(self):                                 # Function to load and read records - File 1 (read Signals).
        ...
        else:                                            # If the system is Linux or other Operating System like Mac
            self.archivo_abierto=filedialog.askopenfilename(initialdir = "/",
                title = "Please, select file",filetypes = (("All Files","*.*"),
                ('SAC Files","*.sac'),
                ('MSEED Files','*.mseed'),
