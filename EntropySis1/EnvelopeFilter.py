...
# Science Faculty,
# Granada University, (Ugr), Spain, 2023 - 2025
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("Images/Ugr.gif"))  # UGR logo
        ...
        self.label_2.setPixmap(QtGui.QPixmap("Images/IAG.gif"))  # IAG logo
        ...
        self.label_4.setPixmap(QtGui.QPixmap("Images/Logodepto.gif"))  # Deparment logo
        ...
        self.label_47.setGeometry(QtCore.QRect(410, 80, 71, 21))
        ...
        self.label_49.setGeometry(QtCore.QRect(694, 140, 71, 21))
        ...
        self.label_57.setGeometry(QtCore.QRect(370, 130, 91, 89))
        self.label_57.setText("")
        self.label_57.setPixmap(QtGui.QPixmap("Images/LogoTSTC.gif"))  # TSTC logo
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(480, 70, 101, 41))
        icon3 = QtGui.QIcon()
        ...
        self.lineEdit_21.setGeometry(QtCore.QRect(230, 175, 41, 20))
        # Qt.ImhFormattedNumbersOnly -> Only allows the use of numbers including decimals and sign (-)
        ...
        self.lineEdit_22.setGeometry(QtCore.QRect(230, 202, 41, 20))
        # Qt.ImhFormattedNumbersOnly -> Only allows the use of numbers including decimals and sign (-)
        ...
        self.pushButton_4.setStyleSheet("background-color: bisque; color: blue")                # Text and Color of the Command Button (Back)
    ...
    def state_changed2(self):                                                # Para comprobar activación del checkBox, Si Lista
            ...
            if self.checkBox.isChecked() == True:
                ...
                if not self.label_5.text():
                    ...
                    for dia in range(Start2, End2 + 1):
                        ...
                        if not os.path.exists(os.path.join(carpeta, archivo)):
                            ...
                            for _ in range(24):  # Añade 24 horas con valor cero si no hay archivo
                        ...
                        # Creación de st para la lectura del fichero
                        st = Stream()
                        st += read(os.path.join(carpeta, archivo))

                        # Creación de st2 para la lectura del fichero
                        st2 = Stream()
                        st2 += read(os.path.join(carpeta, archivo))

                        # Creación de st3 para la lectura del fichero
                        st3 = Stream()
                        st3 += read(os.path.join(carpeta, archivo))

                        # Creación de st4 para la lectura del fichero
                        st4 = Stream()
                        st4 += read(os.path.join(carpeta, archivo))

                        # Creación de st5 para la lectura del fichero
                        st5 = Stream()
                        ...
                        # Dividir los datos en horas y calcular entropía para cada hora con st2
                        for hora in range(24*6):
                            ...
                            if len(datos_hora2) < 600 * 100:  # Si la hora está incompleta, agregar ceros al final
                        ...
                        # Dividir los datos en horas y calcular entropía para cada hora con st3
                        for hora in range(24*6):
                            inicio = hora * 600 * 100  # inicio de la hora en segundos
                            fin = inicio + 600 * 100  # fin de la hora en segundos
                            datos_hora3 = datos3[inicio:fin]

                            if len(datos_hora3) < 600 * 100:  # Si la hora está incompleta, agregar ceros al final
                        ...
                        # Dividir los datos en horas y calcular entropía para cada hora con st4
                        for hora in range(24*6):
                            inicio = hora * 600 * 100  # inicio de la hora en segundos
                            fin = inicio + 600 * 100  # fin de la hora en segundos
                            datos_hora4 = datos4[inicio:fin]

                            if len(datos_hora4) < 600 * 100:  # Si la hora está incompleta, agregar ceros al final
                        ...
                        # Dividir los datos en horas y calcular entropía para cada hora con st5
                        for hora in range(24*6):
                            inicio = hora * 600 * 100  # inicio de la hora en segundos
                            fin = inicio + 600 * 100  # fin de la hora en segundos
                            datos_hora5 = datos5[inicio:fin]

                            if len(datos_hora5) < 600:  # Si la hora está incompleta, agregar ceros al final
                    ...
                    # Creación del array de la entropia normal y la promediada de Shannon para st1
                    entropia_shannon = np.array(entropia_shannon)
                    entropia_promediada = np.array(entropia_promediada)

                    # Creación del array de la entropia normal y la promediada de Shannon para st2
                    entropia_shannon2 = np.array(entropia_shannon2)
                    entropia_promediada2 = np.array(entropia_promediada2)

                    # Creación del array de la entropia normal y la promediada de Shannon para st3
                    entropia_shannon3 = np.array(entropia_shannon3)
                    entropia_promediada3 = np.array(entropia_promediada3)

                    # Creación del array de la entropia normal y la promediada de Shannon para st4
                ...
                if not self.label_5.text():
                    ...
                    for dia in range(1, timeIn + 1):
                        ...
                        # If there is no file in the list, the entire day is added with a value of zero
                        if not os.path.exists(os.path.join(carpeta, archivo)):
                            for _ in range(24*6):  # Añade 24 horas con valor cero si no hay archivo
                                entropia_shannon.append(0)
                                entropia_promediada.append(0)
                            continue
                    ...
                    # Gráfico de Entropía de Shannon
            ...
            if self.checkBox.isChecked() == True:
                ...
                if not self.label_5.text():
                    ...
                    for dia in range(Start2, End2 + 1):
                        ...
                        # Creación de las entropias en base a los datos con st
                        for hora in range(24*6):
                            inicio = hora * 600 * 100  # start of time in seconds.
                            fin = inicio + 600 * 100  # End of time in seconds.
                            datos_hora = datos[inicio:fin]
                        ...
                        for hora in range(24*6):
                            ...
                            if len(datos_hora5) < 600 * 100:  # Si la hora está incompleta, agregar ceros al final
                                datos_hora5 = np.append(datos_hora5, np.zeros(600 * 100 - len(datos_hora5)))
                ...
                if not self.label_5.text():
                    ...
                    for dia in range(1, timeIn + 1):
                        ...
                        # Dividir los datos en horas y calcular entropía para cada hora con st
                        for hora in range(24*6):
                            inicio = hora * 600 * 100  # inicio de la hora en segundos
                            fin = inicio + 600 * 100  # fin de la hora en segundos
                            ...
                            if len(datos_hora) < 600 * 100:  # Si la hora está incompleta, agregar ceros al final
                                datos_hora = np.append(datos_hora, np.zeros(600 * 100 - len(datos_hora)))
