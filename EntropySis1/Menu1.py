...
# Main Menu of Shannon Entropy Estimator for the Characterization of Seismic-Volcanic Signals using Python Software.
...
# Program: Menu1.py -> Main Menu of Shannon Entropy Estimator for the Characterization of Seismic-Volcanic Signals using Python.
...
class Ui_MainWindow(object):                        # Main Class of Program Ui_MainWindow, Object: MainWindow.
    def setupUi(self, MainWindow):                  # Main function class and MainWindow object.
        ...
        self.label.setGeometry(QtCore.QRect(25, 10, 475, 21))
        font = QtGui.QFont()
        ...
        self.label_3.setPixmap(QtGui.QPixmap("Images/Ugr.gif"))  # UGR logo
        ...
        self.label_4.setPixmap(QtGui.QPixmap("Images/LogoTSTC.gif")) # TSTC logo
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:9pt; font-style:italic; color:#00007f;\">Shannon Entropy Estimator for the Characterization of Seismic-Volcanic Signals using Python.</span></p></body></html>"))
    ...
    # Command buttons, Call to functions
        ...
        self.pushButton_2.clicked.connect(self.Smoothing1)                                  # Call the function to read records (smoothing1 - Read)
    ...
    def Entropy_estimator(self):   # Call function to Shannon Entropy, Kurtosis, Frequency Index and Energy estimator for Characterization of Volcanic Seismic Signals program.
        if System1 == "Windows":                                                    # In case it's Windows
            subprocess.Popen(["python", "Entropy1.py"])
            app.quit()

        else:                                                                       # In case it's Linux or other Operating System like Mac
    ...
    def Read_records(self):   # Call function toPerforms the read, filtering and plot the seismic signals program.
        if System1 == "Windows":                                                    # In case it's Windows
